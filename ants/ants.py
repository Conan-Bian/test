...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                assert  not (self.ant.container and  insect.container), 'Two ants in {0}'.format(self)
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if isinstance(insect,QueenAnt) and insect.index:
                return 
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive,min = - float('inf'),max = float('inf')):
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            ...
            self.place.ant = None
            for i in bees :
                if i in self.place.bees:
                    i.armor -= self.damage
                    if i.armor <= 0 :
                        self.place.bees.remove(i)
...
class LongThrower(ThrowerAnt):
    ...
    def nearest_bee(self,hive):
        return ThrowerAnt.nearest_bee(self,hive,self.min_range,float('inf'))
    # END Problem 4
...
class ShortThrower(ThrowerAnt):
    ...
    implemented = True   # Change to True to view in the GUI
    def nearest_bee(self,hive):
        return ThrowerAnt.nearest_bee(self,hive,- float('inf'),self.max_range)
    # END Problem 4
    ...
    def action(self, colony):
        ...
        if self.digesting == 0 :
            if self.place.bees :
                ...
                bee = random.sample(self.place.bees,1)[0]
                self.eat_bee(bee)
        else:
            self.digesting -= 1
        # END Problem 6
...
# END Problem 13
    ...
    # BEGIN Problem 13
    implemented = True
    food_cost = 7   # Change to True to view in the GUI
    is_Queen = True
    # END Problem 13
    ...
    def action(self, colony):
        ...
        if not self.index:
            ...
            bp = self.place.exit 
            while bp != None and not isinstance(bp,Hive):
                if bp.ant :
                    if bp.ant.container and bp.ant.ant and bp.ant.ant not in self.twice:
                        bp.ant.ant.damage *= 2
                        self.twice.append(bp.ant.ant)
                    if bp.ant not in self.twice:
                        bp.ant.damage *= 2
                        self.twice.append(bp.ant)
                bp = bp.exit
